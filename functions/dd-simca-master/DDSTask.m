classdef DDSTask<handle
   ...
   properties
      ...
      AcceptancePlotTitle % Additional figure title shown on the acceptance plot
      AcceptancePlotData %New!--Added by Michael Fong
   end
   ...
   methods
      ...
      function [AcceptancePlotData, handle] = AcceptancePlot(self)
        ...
        if ~isempty(self.Model.CriticalLevel)
            ...
            plot(x, y, '-g');
                ...
                if(self.ShowLabels)
                 ...
                 %Edits by Michael Fong----Save plotting data for custom
                %plots.
               AcceptancePlotData.x=x;
             AcceptancePlotData.y=y;
             AcceptancePlotData.SD_New=SD_New;
               AcceptancePlotData.OD_New=OD_New;
                %--END EDITS---%
